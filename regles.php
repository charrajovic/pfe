...
$sql = " SELECT * FROM `réglementation` WHERE 1 ";
...
<head>
  ...
  <title>consultation les regles d'aménagement</title>
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              ...
              <li><a href="regles"><b>-> </b>consultation les régles</a></li>
            </ul>
          </li>
          <li class="sub-menu">
            <a href="list">
      ...
      <section class="wrapper">
          <div class="row" style="margin:20px auto 10px">
              <div class="offset-md-3 col-md-6">
                <input type="text" class="form-control sear" id="searche" placeholder="search by titre"/>
              </div>
          </div>
      <div class="row">
          ...
          <td>Affecter a</td>
           ...
           {
               ?><tr><td><?php echo $kar[0]; ?></td><td class="zoness"><?php echo $kar[1]; ?></td><td><?php echo $kar[2]; ?></td><td><?php echo $kar[3]; ?></td></tr><?php
           }
